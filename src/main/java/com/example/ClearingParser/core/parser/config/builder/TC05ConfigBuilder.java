...
public class TC05ConfigBuilder {
    ...
    public ParserConfig createTCR0Config() {
    ...
    public ParserConfig createTCR1Config() {
        List<FieldDefinition> fields = Arrays.asList(
    ...
    public ParserConfig createTCR2Config() {
        List<FieldDefinition> fields = Arrays.asList(
    ...
    public ParserConfig createTCR4Config() {
        List<FieldDefinition> fields = Arrays.asList(
    ...
    public ParserConfig createTCR5Config() {
        List<FieldDefinition> fields = Arrays.asList(
    ...
    public ParserConfig createTCR6Config() {
        List<FieldDefinition> fields = Arrays.asList(
        ...
        return ParserConfig.create("tcr6", fields);
    }

    public ParserConfig createTCR7Config() {
        List<FieldDefinition> fields = Arrays.asList(
    ...
    public ParserConfig createTCRDTQ0Config() {
        List<FieldDefinition> fields = Arrays.asList(
        ...
        log.debug("Created TCRD TQ0 configuration with {} fields", fields.size());
        return ParserConfig.create("tcrdtq0", fields);
    }

    public ParserConfig createTCRDTQ2Config() {
        List<FieldDefinition> fields = Arrays.asList(
                FieldDefinition.builder().name("BUSINESS_FORMAT_CODE").position(5).length(2).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig createTCR3BusinessCRConfig() {
        ...
        return ParserConfig.create("tcr3CR", fields);
    }
}
