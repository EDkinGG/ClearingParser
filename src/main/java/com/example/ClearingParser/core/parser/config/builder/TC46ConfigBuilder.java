...
public class TC46ConfigBuilder {
    ...
    public ParserConfig getTcr0SubReport2Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("CREDIT_AMOUNT").position(111).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("DEBIT_AMOUNT").position(126).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("NET_AMOUNT").position(141).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("NET_AMOUNT_SIGN").position(156).length(2).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReport3Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("CREDITS_AMOUNT").position(110).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("DEBITS_COUNT").position(125).length(11).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("DEBITS_AMOUNT").position(136).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("TOTAL_AMOUNT").position(151).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReport5Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("NET_SETTLEMENT_AMOUNT").position(146).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReport6Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("AMOUNT").position(104).length(15).type(FieldDefinition.FieldType.STRING).build(),
                ...
                FieldDefinition.builder().name("PAYMENT_AMOUNT").position(147).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReport7Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("CREDIT_AMOUNT").position(67).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("DEBIT_AMOUNT").position(82).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("NET_AMOUNT").position(97).length(15).type(FieldDefinition.FieldType.STRING).build(),
                ...
                FieldDefinition.builder().name("NET_AMOUNT_IN_SETTLEMENT_CURRENCY").position(146).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReportAConfig() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("AMOUNT").position(114).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr0SubReportEConfig() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("NET_AMOUNT_IN_SETTLEMENT_SERVICE_BALANCE_CURRENCY").position(135).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr1Report4Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("FIRST_AMOUNT").position(42).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIRST_AMOUNT_SIGN").position(57).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SECOND_AMOUNT").position(59).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SECOND_AMOUNT_SIGN").position(74).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("THIRD_AMOUNT").position(76).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("THIRD_AMOUNT_SIGN").position(91).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FOURTH_AMOUNT").position(93).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FOURTH_AMOUNT_SIGN").position(108).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIFTH_AMOUNT").position(110).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIFTH_AMOUNT_SIGN").position(125).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SIXTH_AMOUNT").position(127).length(15).type(FieldDefinition.FieldType.STRING).build(),
    ...
    public ParserConfig getTcr1Report9Config() {
        List<FieldDefinition> fields = Arrays.asList(
                ...
                FieldDefinition.builder().name("FIRST_AMOUNT").position(35).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIRST_AMOUNT_SIGN").position(50).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SECOND_AMOUNT").position(52).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SECOND_AMOUNT_SIGN").position(67).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("THIRD_AMOUNT").position(69).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("THIRD_AMOUNT_SIGN").position(84).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FOURTH_AMOUNT").position(86).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FOURTH_AMOUNT_SIGN").position(101).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIFTH_AMOUNT").position(103).length(15).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("FIFTH_AMOUNT_SIGN").position(118).length(2).type(FieldDefinition.FieldType.STRING).build(),
                FieldDefinition.builder().name("SIXTH_AMOUNT").position(120).length(15).type(FieldDefinition.FieldType.STRING).build(),
